...
// Next.js page module may not carry extra named exports (the webpack
// production builder's type-check rejects them, even though Turbopack
// doesn't enforce it), but tests/route-metadata.test.ts needs to import and
